...
<div id="ordercallback-modal" class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h2 class="uk-h2"><?php echo $ordercallback_settings['modal_title'];?></h2>
        </div>
...
<script type="text/javascript">
    $(function () {
        $('input[name="ordercallback-phone"]').mask("<?php echo (isset($ordercallback_settings['field_phone_mask']) && !empty($ordercallback_settings['field_phone_mask'])) ? $ordercallback_settings['field_phone_mask'] : '(999)-999-9999';?>");
